...
def home(request):
    ...
    if word:
        ...
        for index, i in enumerate(results):
            score_tfidf = similarities_tfidf['url'][index] + similarities_tfidf['title'][index] + similarities_tfidf['description'][index]
            score_rank = similarities_rank['url'][index] + similarities_rank['title'][index] + similarities_rank['description'][index]
